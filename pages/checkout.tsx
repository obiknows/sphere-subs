...
export default function CheckOutPage(cart: any) {
  ...
  // on form failure redirect to  fresh product page (form refresh) with query param msg
  // on form success redirect to success page
  const handleCheckout = (e: React.SyntheticEvent) => {
    // prevent default form submission,
    e.preventDefault()
    router.push("/success") // on successful
  }
  ...
  return (
    <>
      {/* Head */}
      <Head>
        <title>Sphere Subs - Checkout</title>
      </Head>
      {/* Body */}
